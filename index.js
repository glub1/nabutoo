...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:NABUTO\n' //NAMA LU
            + 'ORG:Owner Bot;\n' // NAMA CONTACT OWNER
            + 'TEL;type=CELL;type=VOICE;waid=556993733829:+55 69 9373-3829\n' // NOMER OWNER
            + 'END:VCARD'
prefix = '!'//PREFIX BOT
blocked = ['556993733829']//NOMER BLOCK
limitawal = '9999'
cr = '*VERIFICADO PELO PIROCUDO NABUTO*'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["556993733829@s.whatsapp.net"] // Nomer Owner
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '556993733829@s.whatsapp.net'//Nomer Owner
                        const isEventon = isGroup ? event.includes(from) : false
                        const isRegister = checkRegisteredUser(sender)
                        pushname = client.contacts[sender] != undefined ? client.contacts[sender].vname || client.contacts[sender].notify : undefined

                        // Options
                        const botName = 'NABUTO'//Nama Bot
                        const ownerName = 'NABUTO<3'//Nama Owner
	...
	case 'hidetag':
            ...
            if (!isRegister) return reply(mess.only.daftarB)
				...
				case 'snowwrite':
					...
					var gbl7 = gh.split("|")[0];
					var gbl8 = gh.split("|")[1];
					if (args.length < 1) return reply(`Enviar pedidos ${prefix}snowwrite teks1|teks2, contoh ${prefix}snowwrite aqulzz|galuh`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
					reply(mess.wait)
				...
				case 'marvellogo':
					...
					if (args.length < 1) return reply(`Enviar pedidos ${prefix}marvellogo texto, exemplo ${prefix}marvellogo NABUTO Criador`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
					reply(mess.wait)
				...
				case 'artinama':
                  ...
                  if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   break
case 'raçaab':
tujuh = fs.readFileSync('./assets/raçaab.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'cara...':
tujuh = fs.readFileSync('./assets/cara....mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'céudepipa':
tujuh = fs.readFileSync('./assets/céudepipa.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'essemanoéloko':
tujuh = fs.readFileSync('./assets/essemanoéloko.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'fazerdinheiro':
...
break
case 'gemidão':
tujuh = fs.readFileSync('./assets/gemidão.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
COMANDO PARA ÁUDIO MP3: case 'peakyblin':
tujuh = fs.readFileSync('./assets/peakyblin.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
COMANDO PARA ÁUDIO MP3: case 'troqueimeuplay':
tujuh = fs.readFileSync('./assets/troqueimeuplay.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bot':
...
break
case 'roi':
tujuh = fs.readFileSync('./assets/roi.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ban':
...
break
case 'shit1':
axios.get = fs.readFileSync('./assets/shit1.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
breakudioase
break
case 'shit2':
axios.get = fs.readFileSync('./assets/shit2.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit3':
axios.get = fs.readFileSync('./assets/shit3.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit4':
axios.get = fs.readFileSync('./assets/shit4.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit5':
axios.get = fs.readFileSync('./assets/shit5.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit6':
axios.get = fs.readFileSync('./assets/shit6.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit7':
axios.get = fs.readFileSync('./assets/shit7.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit8':
axios.get = fs.readFileSync('./assets/shit8.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit9':
axios.get = fs.readFileSync('./assets/shit9.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit10':
axios.get = fs.readFileSync('./assets/shit10.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit11':
axios.get = fs.readFileSync('./assets/shit11.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit12':
axios.get = fs.readFileSync('./assets/shit12.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit13':
axios.get = fs.readFileSync('./assets/shit13.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit14':
axios.get = fs.readFileSync('./assets/shit14.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit15':
axios.get = fs.readFileSync('./assets/shit15.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit16':
axios.get = fs.readFileSync('./assets/shit16.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit17':
axios.get = fs.readFileSync('./assets/shit17.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit18':
axios.get = fs.readFileSync('./assets/shit18.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit19':
axios.get = fs.readFileSync('./assets/shit19.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit20':
axios.get = fs.readFileSync('./assets/shit20.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit21':
axios.get = fs.readFileSync('./assets/shit21.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit22':
axios.get = fs.readFileSync('./assets/shit22.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit23':
axios.get = fs.readFileSync('./assets/shit23.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit24':
axios.get = fs.readFileSync('./assets/shit25.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit26':
axios.get = fs.readFileSync('./assets/shit27.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit28':
axios.get = fs.readFileSync('./assets/shit28.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit29':
axios.get = fs.readFileSync('./assets/shit29.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit30':
axios.get = fs.readFileSync('./assets/shit30.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit31':
axios.get = fs.readFileSync('./assets/shit31.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit32':
axios.get = fs.readFileSync('./assets/shit32.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit33':
axios.get = fs.readFileSync('./assets/shit33.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit34':
axios.get = fs.readFileSync('./assets/shit34.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit35':
axios.get = fs.readFileSync('./assets/shit35.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit36':
axios.get = fs.readFileSync('./assets/shit36.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit37':
axios.get = fs.readFileSync('./assets/shit37.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit38':
axios.get = fs.readFileSync('./assets/shit38.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit39':
axios.get = fs.readFileSync('./assets/shit39.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit40':
axios.get = fs.readFileSync('./assets/shit40.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit41':
axios.get = fs.readFileSync('./assets/shit42.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit42':
axios.get = fs.readFileSync('./assets/shit41.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit43':
axios.get = fs.readFileSync('./assets/shit43.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit44':
axios.get = fs.readFileSync('./assets/shit44.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit45':
axios.get = fs.readFileSync('./assets/shit45.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit46':
axios.get = fs.readFileSync('./assets/shit46.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit47':
axios.get = fs.readFileSync('./assets/shit47.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit48':
axios.get = fs.readFileSync('./assets/shit48.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit49':
axios.get = fs.readFileSync('./assets/shit49.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit50':
axios.get = fs.readFileSync('./assets/shit50.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit51':
axios.get = fs.readFileSync('./assets/shit51.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit52':
axios.get = fs.readFileSync('./assets/shit52.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit53':
axios.get = fs.readFileSync('./assets/shit53.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit54':
axios.get = fs.readFileSync('./assets/shit54.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit55':
axios.get = fs.readFileSync('./assets/shit55.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'shit56':
axios.get = fs.readFileSync('./assets/shit56.mp4');
dark.sendMess(from, axios.get, video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
 'infonomor':
               client.updatePresence(from, Presence.composing) 
	...
	case 'kbbi':
		...
		case 'glass':                                        
               ...
               if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				dark.updatePresence(from, Presence.composing) 
                 ...
                 reply('pq senhor?🙁, esse gp só tem punheteiro...')
		...
		case 'info':
					...
					buffer = await getBuffer(`https://pin.it/1kbjtnJ`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'INFORMAÇÕES SOBRE O *NABUTO BOT*/nATUALIZADO DIA 03/03/22/nDONO: NABUTO/nWHATSAPP DO DONO: wa.me/556993733829/nCANAL NO YOUTUBE: https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w'})
					break
		case 'grupos':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://pin.it/1kbjtnJ`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'GRUPO 1:https://chat.whatsapp.com/J2ZGIuyEx1hAUmjjIqXZD5/nGRUPO2: https://chat.whatsapp.com/DFmKl2MyPZvDzgDZIWr6l0/nGRUPO3: https://chat.whatsapp.com/I7cVA8hJBfZ7LiDtCEu1Nf'})
					break
case 'teste':
tujuh = fs.readFileSync('./assets/teste.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
				case 'naruto':
				...
				case 'animecry':
                   ...
                   if (!isGroup) return reply(mess.only.group)
					...
					cry = getRandom('.gif')
					rano = getRandom('.webp')
					anu = awat fetchJson(`https://images.app.goo.gl/ks2cbWxTk8zbzEmT8`, {method: 'get'})
                   if (!isGroup) return reply(mess.only.group)
					reply (mess.wait)
					exec(`wget ${anu.result} -O ${cry} && ffmpeg -i ${cry} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(cry)
					...
					cry = getRandom('.gif')
					rano = getRandom('.webp')
					anu = awat fetchJson(`https://images.app.goo.gl/ks2cbWxTk8zbzEmT8'})
                   if (!isGroup) return reply(mess.only.group)
					reply (mess.wait)
					exec(`wget ${anu.result} -O ${cry} && ffmpeg -i ${cry} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(cry)
				...
				case 'neonime':
					...
					break  
					case 'bpink':
                  if (args.length < 1) return reply(`Entrada de texto\Exemplo : ${prefix}NABUTO Bot`)
			...
			mus = body.slice(6)
               ...
               if (mus1.error) return reply(mus1.error)
				...
				case 'logowolf2':
					...
					if (args.length < 1) return reply(`teksnya mana? contoh ${prefix}logowolf NABUTO|bot`)
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        if (isLimit(sender)) return reply(ind.limitend(pusname))
					reply(mess.wait)
			       ...
			       reply(anu.result.jadwalTV)
					break*/
                                ...
                                case '8bit':
                                        ...
                                        var bi2 = bi.split("|")[0];
                                        var bit = bi.split("|")[1];
                                        if (args.length < 1) return reply('teksnya mana um\nContoh: ${prefix}8bit NABUTO|Anjay')
                                        if (!isRegister) return reply(mess.only.daftarB)
                                        reply(mess.wait)
